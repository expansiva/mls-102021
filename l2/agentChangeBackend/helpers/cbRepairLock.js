...
exports.serializeRepairMutation = serializeRepairMutation;
...
function serializeRepairMutation(operation) {
    return __awaiter(this, void 0, void 0, function () {
        var previous, release;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    previous = mutationQueue;
                    mutationQueue = new Promise(function (resolve) { release = resolve; });
