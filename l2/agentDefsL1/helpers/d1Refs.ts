...
export const D1_FIELD_READERS = {
  ...
  'usecase.mdm.calls.id': 'readUsecaseFidelity',
  'usecase.mdm.calls.when': 'readUsecaseFidelity',
  'usecase.mdm.calls.when.kind': 'readUsecaseFidelity',
  'usecase.mdm.calls.when.path': 'readUsecaseFidelity',
  'usecase.mdm.calls.when.call': 'readUsecaseFidelity',
  'usecase.mdm.calls.when.present': 'readUsecaseFidelity',
  'usecase.mdm.calls.arguments.path': 'readUsecaseFidelity',
  'usecase.mdm.calls.arguments.value': 'readUsecaseFidelity',
  'usecase.mdm.calls.arguments.origin': 'readUsecaseFidelity',
  'usecase.mdm.calls.arguments.origin.kind': 'readUsecaseFidelity',
  'usecase.mdm.calls.arguments.origin.path': 'readUsecaseFidelity',
  'usecase.mdm.calls.arguments.origin.calls': 'readUsecaseFidelity',
  'usecase.mdm.calls.arguments.origin.evidence': 'readUsecaseFidelity',
  ...
  'accessScope.grants.path.entityId': 'reconstructAccessPolicy',
  'accessScope.grants.path.steps': 'reconstructAccessPolicy',
  'accessScope.grants.path.steps.relationshipId': 'reconstructAccessPolicy',
  'accessScope.grants.path.steps.from': 'reconstructAccessPolicy',
  'accessScope.grants.path.steps.to': 'reconstructAccessPolicy',
  'accessScope.grants.path.steps.field': 'accessScopeIssues',
  'accessScope.grants.path.pending': 'accessScopeIssues',
